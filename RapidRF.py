...
def radio_info():
    ...
    print("Default is {}MHZ [Enter]".format(RRF_config.input_freq))
    ...
    print("Default is {} [Enter]".format(RRF_config.input_gain))
    print(dis_under_line)
...
def replay_only_radio_info():
    ...
    print("Default is {}MHZ [Enter]".format(RRF_config.output_freq))
    print(dis_under_line)
...
def load_play():
    ...
    print(dis_lines)
    print("1.Load and [R]eplay                            [R]")
    print("2.Load Play on [L]oop                          [L]")
    print("3.[C]hange Freq                                [C]")
    print("4.[B]ack                               [B] [Enter]")
    print("5.[Q]uit                                       [Q]")
    print(dis_under_line)
...
def main_screen():
    ...
    print("RapidRF")
    print(dis_lines)
    print("1.[R]ec NOW                            [R] [Enter]")
    print("2.Re[P]lay                                     [P]")
    print("3.RePlay on [L]oop                             [L]")
    print("4.[S]ave                                       [S]")
    print("5.Load [A]nd Replay                            [A]")
    print("6.Save AND [M]ake Bash script                  [M]")
    print("7.[C]hange Freq                                [C]")
    print("8.[Q]uit                                       [Q]")
    print(dis_under_line)
